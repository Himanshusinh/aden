        ...
        <div className="footer-grid">
          <div>
            <Link href="/" className="brand" style={{ display: "inline-flex", flexDirection: "column", alignItems: "flex-start", textDecoration: "none", marginBottom: "16px" }}>
              <div style={{ width: '170px', height: '48px', display: 'flex', alignItems: 'center', justifyContent: 'flex-start' }}>
              ...
              <span style={{ fontFamily: "var(--font-display)", fontWeight: "800", fontSize: "14px", letterSpacing: "0.15em", color: "#ffffff", textTransform: "uppercase", lineHeight: "1", marginTop: "-10px" }}>
                A.D.Engineers
              </span>
            </Link>
